...
export default function CurrencySelector(): JSX.Element {
    ...
    return (
        <div className="hidden lg:ml-8 lg:flex">
            <a href="#" className="flex items-center text-gray-50 hover:text-primary-300">
                <span className="bg-[linear-gradient(0deg,_#D22630_50%,_#FFF_50%)]"></span>
                <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width="25px" height="25px" fill="#000000">
                    <g id="SVGRepo_bgCarrier" strokeWidth="0"></g>
                    <g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g>
                    <g id="SVGRepo_iconCarrier">
                        <rect x="114.76" y="88.277" width="282.48" height="335.45" fill="#F5F5F5"></rect>
                        <g>
                            <path fill="#FF4B55" d="M38.345,88.273C17.167,88.273,0,105.44,0,126.618v258.759c0,21.177,17.167,38.345,38.345,38.345 h76.414V88.273H38.345z"></path>
                            <path fill="#FF4B55" d="M473.655,88.273h-76.414v335.448h76.414c21.177,0,38.345-17.167,38.345-38.345V126.618 C512,105.44,494.833,88.273,473.655,88.273z"></path>
